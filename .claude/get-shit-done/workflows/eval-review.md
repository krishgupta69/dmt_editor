...
```bash
AUDITOR_MODEL=$(node "C:/Users/kirsh/Documents/GitHub/dmt_editor/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read C:/Users/kirsh/Documents/GitHub/dmt_editor/.claude/agents/gsd-eval-auditor.md for instructions.
